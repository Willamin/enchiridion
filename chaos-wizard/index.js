...
/***/ function(module, exports, __webpack_require__) {
	...
	state.frame = new _Frame2.default(), state.game = new _Game2.default({
	    ...
	    waves: [{
	        ...
	        capacity: 1,
	        killcount: 1,
	        monsters: [_monsters2.default.CHAOS_WIZARD],
...
/***/ function(module, exports) {
	...
	module.exports = "data:image/png;base64,"

/***/ },
/* 182 */
/***/ function(module, exports) {

	module.exports = "data:image/png;base64,"
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    CHAOS_WIZARD: {
	        sprite: _data2.default.SPRITES.MONSTERS.CHAOS_WIZARD,
	        ...
	        onSpawn: function onSpawn() {
	            this.spawnSomeBats = function () {
	                ...
	                var countToSpawn = function countToSpawn() {
	                    if (_this.health < 3) {
	                        return 8;
	                    } else if (_this.health < 6) {
	                        return 4;
	                    } else {
	                        return 2;
	                    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Monster = function () {
	    ...
	    _createClass(Monster, [{
	        ...
	        key: "getFreeSpace",
	        value: function getFreeSpace(depth) {
	            var _this2 = this;
	            ...
	            var x = Math.floor(Math.random() * _data2.default.FRAME.WIDTH);
	            var y = Math.floor(Math.random() * _data2.default.FRAME.HEIGHT * this.game.adventurer.wave * -1);
	            this.game.monsters.forEach(function (monster) {
	                if (monster) {
	                    if (monster.position.x == x && monster.position.y == y) {
	                        return _this2.getFreeSpace(depth + 1);
	                    }
	                }
	            });
	        ...
	        key: "getDistanceToAdventurer",
	        value: function getDistanceToAdventurer() {
