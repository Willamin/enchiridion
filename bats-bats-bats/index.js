	...
	var Game = function () {
	    function Game(protogame) {
	        ...
	        this.wave = new _MonsterWave2.default({
	            ...
	            data: {
	                capacity: 4,
	                monsters: [_monsters2.default.RED_SLIME, _monsters2.default.BLUE_SLIME, _monsters2.default.RED_ORC, _monsters2.default.BLUE_ORC, _monsters2.default.GREEN_ORC, _monsters2.default.WHITE_TROLL, _monsters2.default.RED_BAT, _monsters2.default.BLUE_BAT, _monsters2.default.GREEN_BAT, _monsters2.default.FAST_BAT]
	            }
	        });
