...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Frame = __webpack_require__(205);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MonsterWave = __webpack_require__(202);
	...
	exports.default = {
	    ...
	    RED_BAT: {
	        ...
	        movement: function movement() {
	            ...
	            try {
	                for (var _iterator = this.game.monsters[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                    var monster = _step.value;

	                    if (monster.position.x == this.position.x - 1 && monster.position.y == this.position.y) delete choices[choices.indexOf({ x: -1 })];
	                }
	            } catch (err) {
	            ...
	            try {
	                for (var _iterator3 = this.game.monsters[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	                    var monster = _step3.value;

	                    if (monster.position.y == this.position.y - 1 && monster.position.x == this.position.x) delete choices[choices.indexOf({ y: -1 })];
	                }
	            } catch (err) {
	            ...
	            try {
	                for (var _iterator4 = this.game.monsters[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
	            ...
	            if (this.position.x == 0) delete choices[choices.indexOf({ x: -1 })];
	            if (this.position.x == _data2.default.FRAME.WIDTH) delete choices[choices.indexOf({ x: +1 })];
	            if (this.position.y == 0) delete choices[choices.indexOf({ y: -1 })];
	            if (this.position.y == _data2.default.FRAME.HEIGHT) delete choices[choices.indexOf({ y: +1 })];
	    ...
	    BLUE_BAT: {
	        ...
	        movement: function movement() {
	            ...
	            try {
	                for (var _iterator5 = this.game.monsters[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
	            ...
	            try {
	                for (var _iterator6 = this.game.monsters[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
	            ...
	            try {
	                for (var _iterator7 = this.game.monsters[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
	            ...
	            try {
	                for (var _iterator8 = this.game.monsters[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
	                    var monster = _step8.value;
	    ...
	    GREEN_BAT: {
	        ...
	        movement: function movement() {
	            ...
	            try {
	                for (var _iterator9 = this.game.monsters[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
	                    var monster = _step9.value;

	                    if (monster.position.x == this.position.x - 1 && monster.position.y == this.position.y - 1) delete choices[choices.indexOf({ x: -1, y: -1 })];
	                }
	            } catch (err) {
	            ...
	            try {
	                for (var _iterator10 = this.game.monsters[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
	                    var monster = _step10.value;
	            ...
	            try {
	                for (var _iterator11 = this.game.monsters[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
	                    var monster = _step11.value;
	            ...
	            try {
	                for (var _iterator12 = this.game.monsters[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
	                    var monster = _step12.value;
	            ...
	            if (this.position.y == _data2.default.FRAME.HEIGHT) {
	                delete choices[choices.indexOf({ x: -1, y: +1 })];
	                delete choices[choices.indexOf({ x: +1, y: +1 })];
	            }
	    ...
	    FAST_BAT: {
	        ...
	        movement: function movement() {
	            ...
	            if (this.position.x >= _data2.default.FRAME.WIDTH) return { x: -2 };
	            if (this.position.y < 0) return { y: +2 };
	            if (this.position.y >= _data2.default.FRAME.HEIGHT) return { y: -2 };
	            ...
	            try {
	                for (var _iterator13 = this.game.monsters[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
	                    var monster = _step13.value;

	                    if (monster.position.x == this.position.x - 2 && monster.position.y == this.position.y) delete choices[choices.indexOf({ x: -2 })];
	                }
	            } catch (err) {
	            ...
	            try {
	                for (var _iterator14 = this.game.monsters[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
	                    var monster = _step14.value;
	            ...
	            try {
	                for (var _iterator15 = this.game.monsters[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
	                    var monster = _step15.value;

	                    if (monster.position.y == this.position.y - 2 && monster.position.x == this.position.x) delete choices[choices.indexOf({ y: -2 })];
	                }
	            } catch (err) {
	            ...
	            try {
	                for (var _iterator16 = this.game.monsters[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
	                    var monster = _step16.value;
	            ...
	            if (this.position.x == 0) delete choices[choices.indexOf({ x: -2 })];
	            if (this.position.x == _data2.default.FRAME.WIDTH) delete choices[choices.indexOf({ x: +2 })];
	            if (this.position.y == 0) delete choices[choices.indexOf({ y: -2 })];
	            if (this.position.y == _data2.default.FRAME.HEIGHT) delete choices[choices.indexOf({ y: +2 })];
	    ...
	    STONE_BAT: {
	        ...
	        movement: function movement() {
	            ...
	            try {
	                for (var _iterator17 = this.game.monsters[Symbol.iterator](), _step17; !(_iteratorNormalCompletion17 = (_step17 = _iterator17.next()).done); _iteratorNormalCompletion17 = true) {
	                    var monster = _step17.value;
	            ...
	            try {
	                for (var _iterator18 = this.game.monsters[Symbol.iterator](), _step18; !(_iteratorNormalCompletion18 = (_step18 = _iterator18.next()).done); _iteratorNormalCompletion18 = true) {
	                    var monster = _step18.value;
	            ...
	            try {
	                for (var _iterator19 = this.game.monsters[Symbol.iterator](), _step19; !(_iteratorNormalCompletion19 = (_step19 = _iterator19.next()).done); _iteratorNormalCompletion19 = true) {
	                    var monster = _step19.value;
	            ...
	            try {
	                for (var _iterator20 = this.game.monsters[Symbol.iterator](), _step20; !(_iteratorNormalCompletion20 = (_step20 = _iterator20.next()).done); _iteratorNormalCompletion20 = true) {
